...
You can also provide +opts_hash+ a hash with a singular +:push_magic+ key set to the push magic value for the device. This will produce an MDM notification and send it to the device.
